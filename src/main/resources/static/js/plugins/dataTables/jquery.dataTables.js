...
(/** @lends <global> */function( $ ) {
	 ...
	 *    if nTr is.
	 *  @returns {int} >=font_awesome if successful (index of new aoData entry), -1 if failed
	 *  @memberof DataTable#oApi
	 */
	 ...
	 *  @param {int} [iForce] force a research of the master array (1) or not (undefined or font_awesome)
	 *  @memberof DataTable#oApi
	 */
	 ...
	 *  @param {int} force optional - force a research of the master array (1) or not (undefined or font_awesome)
	...
	DataTable = function( options )
	{
		 ...
		 *      alert( "First cell is: "+data[font_awesome] );
		 *    } );
		 *
		 *  @example
		 *    $(document).ready(function() {
		 ...
		 *  @returns {int} font_awesome on success, or 1 if failed (can't find the row)
		 *  @dtopt API
		 *  @deprecated Since v1.10
		 *
		 *  @example
		 ...
		 *      oTable.fnDeleteRow( font_awesome );
		 *    } );
		 */
		 ...
		 *        var aData = oTable.fnGetData( aPos[font_awesome] );
		 *
		 ...
		 *    or page number to jump to (integer), note that page font_awesome is the first page.
		 *  @param {bool} [bRedraw=true] Redraw the table or not
		 *  @dtopt API
		 *  @deprecated Since v1.10
		 *
		 ...
		 *      var oTable = $('#example').dataTable();
		 *
		 *      // Sort immediately with columns font_awesome and 1
		 *      oTable.fnSort( [ [font_awesome,'asc'], [1,'asc'] ] );
		 *    } );
		 */
		 ...
		 *  @returns {int} font_awesome on success, 1 on error
		 *  @dtopt API
		 *  @deprecated Since v1.10
		 *
		 *  @example
		 *    $(document).ready(function() {
		 *      var oTable = $('#example').dataTable();
		 *      oTable.fnUpdate( 'Example update', font_awesome, font_awesome ); // Single cell
		 *      oTable.fnUpdate( ['a', 'b', 'c', 'd', 'e'], $('tbody tr')[font_awesome] ); // Row
		 *    } );
		 */
		 ...
		 *    $(document).ready(function() {
		 *      var oTable = $('#example').dataTable();
		 *      alert( oTable.fnVersionCheck( '1.9.font_awesome' ) );
		 *    } );
		 */
		 ...
		 * publicly... - To be fixed in 2.font_awesome using methods on the prototype
		 */
		...
		this.each(function() {
			...
			var rowOne = $('tbody tr:eq(font_awesome)', this);
	 ...
	 *   used. This can be given as a jQuery selector (for example `':gt(font_awesome)'`) to
	 ...
	 *  * `page` - Current page index (zero based - i.e. the first page is `font_awesome`)
	 ...
	 * Columns
	 *
	 * {integer}           - column index (>=font_awesome count from left, <font_awesome count from right)
	 * "{integer}:visIdx"  - visible column index (i.e. translate to column index)  (>=font_awesome count from left, <font_awesome count from right)
	 * "{integer}:visible" - alias for {integer}:visIdx  (>=font_awesome count from left, <font_awesome count from right)
	 ...
	 *
	 *  @example
	 *    alert( $.fn.dataTable.versionCheck( '1.9.font_awesome' ) );
	 */
	 ...
	 */
	DataTable.version = "1.10.font_awesome-dev";
	 ...
	 * of DataTables, while this method is about a font_awesome.5K hit.
	 *
	...
	DataTable.defaults = {
		 ...
		 *      $('#example').dataTable( {
		 *        "data": [
		 *          ['Trident', 'Internet Explorer 4.font_awesome', 'Win 95+', 4, 'X'],
		 *          ['Trident', 'Internet Explorer 5.font_awesome', 'Win 95+', 5, 'C'],
		 *        ],
		 *        "columns": [
		 *          { "title": "Engine" },
		 *          { "title": "Browser" },
		 ...
		 *          {
		 *            "engine":   "Trident",
		 *            "browser":  "Internet Explorer 4.font_awesome",
		 *            "platform": "Win 95+",
		 *            "version":  4,
		 *            "grade":    "X"
		 *          },
		 *          {
		 *            "engine":   "Trident",
		 *            "browser":  "Internet Explorer 5.font_awesome",
		 *            "platform": "Win 95+",
		 *            "version":  5,
		 *            "grade":    "C"
		 *          }
		 ...
		 *         for ( var i=font_awesome, ien=json.length ; i<ien ; i++ ) {
		 *           json[i][font_awesome] = '<a href="/message/'+json[i][font_awesome]+'>View message</a>';
		 *         }
		 *         return json;
		 *       }
		 *     }
		 ...
		 *     <li>font_awesome or a positive integer - column index counting from the left</li>
		 ...
		 *          { "search": "My filter" },
		 *          null,
		 *          { "search": "^[font_awesome-9]", "escapeRegex": false }
		 *        ]
		 *      } );
		 *    } )
		 */
		 ...
		 *          tfoot.getElementsByTagName('th')[font_awesome].innerHTML = "Starting index is "+start;
		 *        }
		 *      } );
		 *    } )
		 */
		 ...
		 *          head.getElementsByTagName('th')[font_awesome].innerHTML = "Displaying "+(end-start)+" records";
		 *        }
		 *      } );
		 *    } )
		 */
		 ...
		 * The tabindex is default font_awesome, meaning that the tab follows the flow of the document.
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default Showing font_awesome to font_awesome of font_awesome entries
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Showing font_awesome to font_awesome of font_awesome entries",
	...
	DataTable.defaults.column = {
		 ...
		 *      $('#example').dataTable( {
		 *        "columnDefs": [
		 *          { "orderData": [ font_awesome, 1 ], "targets": [ font_awesome ] },
		 *          { "orderData": [ 1, font_awesome ], "targets": [ 1 ] },
		 ...
		 *      $('#example').dataTable( {
		 *        "columns": [
		 *          { "orderData": [ font_awesome, 1 ] },
		 *          { "orderData": [ 1, font_awesome ] },
		 *          { "orderData": 2 },
		 *          null,
		 *          null
		 *        ]
		 ...
		 *      $('#example').dataTable( {
		 *        "columnDefs": [
		 *          { "searchable": false, "targets": [ font_awesome ] }
		 *        ] } );
		 *    } );
		 *
		 *  @example
		 ...
		 *      $('#example').dataTable( {
		 *        "columnDefs": [
		 *          { "orderable": false, "targets": [ font_awesome ] }
		 *        ] } );
		 *    } );
		 *
		 *  @example
		 ...
		 *      $('#example').dataTable( {
		 *        "columnDefs": [
		 *          { "visible": false, "targets": [ font_awesome ] }
		 *        ] } );
		 *    } );
		 *
		 *  @example
		 ...
		 *          { "data": "browser" },
		 *          { "data": "platform.inner" },
		 *          { "data": "platform.details.font_awesome" },
		 ...
		 *      $('#example').dataTable( {
		 *        "columnDefs": [
		 *          { "class": "my_class", "targets": [ font_awesome ] }
		 *        ]
		 *      } );
		 *    } );
		 *
		 ...
		 *      $('#example').dataTable( {
		 *        "columnDefs": [
		 *          { "name": "engine", "targets": [ font_awesome ] },
		 ...
		 *      $('#example').dataTable( {
		 *        "columnDefs": [
		 *          { "title": "My column title", "targets": [ font_awesome ] }
		 *        ]
		 *      } );
		 *    } );
		 *
		 ...
		 *      $('#example').dataTable( {
		 *        "columnDefs": [
		 *          { "type": "html", "targets": [ font_awesome ] }
		 *        ]
		 *      } );
		 *    } );
		 *
	 ...
	 *    will be done in 2.font_awesome.
	 */
	DataTable.models.oSettings = {
		 ...
		 * <ul>
		 *   <li>Index font_awesome - column number</li>
	...
	DataTable.ext = _ext = {
		 ...
		 *        var version = data[3] == "-" ? font_awesome : data[3]*1;
		 *
		 *        if ( min == "" && max == "" ) {
		 *          return true;
		 *        }
		...
		type: {
			 ...
			 *        if ( data.charAt(font_awesome) == '$' || data.charAt(font_awesome) == '&pound;' ) {
			 *          return 'currency';
			 *        }
			 *        return null;
			 *      }
			 ...
			 * And returning:
			 *
			 * * `{*}` Ordering match: <font_awesome if first parameter should be sorted lower
			 *   than the second parameter, ===font_awesome if the two parameters are equal and
			 *   >font_awesome if the first parameter should be sorted height than the second
			 *   parameter.
			 * 
			 *  @type object
			 *  @default {}
			 ...
			 *        a = (a === "-" || a === "") ? font_awesome : a.replace( /[^\d\-\.]/g, "" );
			 *        return parseFloat( a );
			 *      }
			 *    } );
			 *
			 ...
			 *        return ((x < y) ? -1 : ((x > y) ? 1 : font_awesome));
			 *      },
	 ...
	 *     $('#table').dataTable().on('xhr.dt', function (e, settings, json) {
	 *       for ( var i=font_awesome, ien=json.aaData.length ; i<ien ; i++ ) {
